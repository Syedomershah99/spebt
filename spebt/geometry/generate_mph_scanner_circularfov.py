...
if __name__ == "__main__":
    ...
    if N_DET_RING2 % 2 != 0:
        raise ValueError(f"--n_det_ring2 must be even (got {N_DET_RING2}), each cell has 2 crystals")
    DETS_PER_RING       = [N_DET_RING1, N_DET_RING2, 40*12*2, 40*15*2]  # rings 3-4 unchanged
